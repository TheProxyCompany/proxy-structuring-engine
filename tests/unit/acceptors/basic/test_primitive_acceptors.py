...
def test_accept_true(boolean_acceptor):
    ...
    assert any(
        walker.accumulated_value() is True for walker in accepted_walkers
...
def test_accept_false(boolean_acceptor):
    ...
    assert any(
        walker.accumulated_value() is False for walker in accepted_walkers
